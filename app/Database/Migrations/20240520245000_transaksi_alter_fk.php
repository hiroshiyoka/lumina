    ...
    class TransaksiAlterFk extends Migration {
        public function up() {
            ...
            $this -> forge -> addColumn('transaksi', [
                'CONSTRAINT transaksi_id_pembeli_foreign FOREIGN KEY(id_pembeli) REFERENCES users(id) ON DELETE NO ACTION ON UPDATE CASCADE',
            ]);
        ...
        public function down() {
            $this -> forge -> addColumn('transaksi', [
                'CONSTRAINT transaksi_id_pembeli_foreign FOREIGN KEY(id_pembeli) REFERENCES users(id)',
            ]);
